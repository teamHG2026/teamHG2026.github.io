...
function updateText() {
    const textBox = document.getElementById("text01"); // 텍스트 박스 ID 확인
    const screenWidth = window.innerWidth; // 현재 화면 너비 가져오기
    ...
    let textContent = `<p>
                ...
                상황의 심각성을 깨달은 여러 부족이 힘을 합쳐 그것들을 없애고 땅을 정화하기로 한다</p>`;

    // 화면 크기 1390px 이하
    if (screenWidth <= 1390 && screenWidth > 990) {
        textContent = `<p>
                옛날 여러 신들이 모여 하나의 세상을 만들었고<br>
                다양한 생명들이 그 땅에 살게 되었다 <br>
                영토를 키우고 싶었던 부족은 서로를 공격하고 <br>
                ...
                모든 생물을 공격하기 시작했고 <br>
                상황의 심각성을 깨달은 여러 부족이 힘을 합쳐 <br>
                그것들을 없애고 땅을 정화하기로 한다</p>`;
    }
    // 화면 크기 990px 이하
    else if (screenWidth <= 990 && screenWidth > 550) {
        textContent = `<p>
                옛날 여러 신들이 모여 하나의 세상을 만들었고<br>
                다양한 생명들이 그 땅에 살게 되었다 <br>
                영토를 키우고 싶었던 부족은 서로를 공격하고 <br>
    ...
    // 화면 크기 550px 이하
        ...
        textContent = `<p>
                ...
                그곳에서 태어난 것들은 본능을 따라<br>
                모든 생물을 공격하기 시작했고 <br>
                상황의 심각성을 깨달은 여러 부족이 <br>
                힘을 합쳐 그것들을 없애고 땅을 <br>
                정화하기로 한다</p>`;
    }
    ...
    if (textBox) {
        ...
        console.error("Element with ID 'text01' not found.");
    }
}
