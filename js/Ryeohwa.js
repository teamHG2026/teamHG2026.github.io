...
function updateText() {
    ...
    let textContent = `<p> 활발한 화산지역에서 온 려화는 화려하게 쌍검과 뜨거운 불을 사용하여 적을 정화하고 소멸시킵니다 <br>
    ...
    if (screenWidth <= 1250 && screenWidth > 750) {
        textContent = `<p> 활발한 화산지역에서 온 려화는 화려하게 쌍검과 뜨거운 불을 사용하여 <br>
                적을 정화하고 소멸시킵니다 <br>
                팀의 최전방에 서서 팀을 이끌며 적을 강하고 빠르게 처치합니다 <br>
                그 누구보다 책임감과 사명감이 강하여 한번 맡은 임무는 항상 잘 해결이 됩니다 <br>
                항상 침착하고 표정의 변화가 크게없는 그녀이지만 <br>
    ...
    // 화면 크기 750px 이하
        ...
        textContent = `<p> 활발한 화산지역에서 온 려화는 화려하게 <br>
